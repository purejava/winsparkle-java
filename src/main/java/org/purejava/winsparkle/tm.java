...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winsparkle_h.C_INT.withName("tm_sec"),
        winsparkle_h.C_INT.withName("tm_min"),
        winsparkle_h.C_INT.withName("tm_hour"),
        winsparkle_h.C_INT.withName("tm_mday"),
        winsparkle_h.C_INT.withName("tm_mon"),
