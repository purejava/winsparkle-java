...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, winsparkle_h.C_POINTER).withName("__locales"),
        winsparkle_h.C_POINTER.withName("__ctype_b"),
        winsparkle_h.C_POINTER.withName("__ctype_tolower"),
        winsparkle_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, winsparkle_h.C_POINTER).withName("__names")
